# zzuClock使用指南 :mega:（手写文字验证码+无验证码，每天凌晨两点自动打卡，邮件提醒）

## 2022.9.10 当前可用，另外fork前请移步当前仓库actions看最新scheduled执行是否成功。

## 2022.9.9 增加了没有验证码的处理情况。系统最近一直在变，由于我是真的没空，本仓库以后不再更新。
